...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('layers_privatesuperoverlay', (
            ...
            ('base_kml', self.gf('django.db.models.fields.FilePathField')(path='/some/non-existent/path', max_length=100, recursive=True)),
        ))
    ...
    models = {
        ...
        'layers.privatesuperoverlay': {
            ...
            'base_kml': ('django.db.models.fields.FilePathField', [], {'path': "'/some/non-existent/path'", 'max_length': '100', 'recursive': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'priority': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
