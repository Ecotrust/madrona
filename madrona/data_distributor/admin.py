...
from madrona.data_distributor.views import run_load_setup
from madrona.data_distributor.models import *

# def load_potential_targets(modeladmin, request, queryset):
#     load_potential_targets(module='madrona')
# load_potential_targets.short_description = 'Load all madrona app models to Potential Targets'
