...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bookmarks_bookmark', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bookmarks_bookmark_related', to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length='255')),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bookmarks_bookmark_related', null=True, to=orm['contenttypes.ContentType'])),
            ...
            ('tilt', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('roll', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('altitudeMode', self.gf('django.db.models.fields.FloatField')(default=1)),
        ))
        db.send_create_signal('bookmarks', ['Bookmark'])

        # Adding M2M table for field sharing_groups on 'Bookmark'
        db.create_table('bookmarks_bookmark_sharing_groups', (
