...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mlpa_estuaries', (
        ...
        db.send_create_signal('mlpa', ['Estuaries'])
        ...
        db.create_table('mlpa_mpaarray', (
            ...
            ('short_name', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
        ...
        # Adding model 'Lop'
        db.create_table('mlpa_lop', (
            ('run', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.IntegerField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('mlpa', ['Lop'])

        # Adding model 'AllowedMethod'
        db.create_table('mlpa_allowedmethod', (
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('mlpa', ['AllowedMethod'])

        # Adding model 'AllowedPurpose'
        db.create_table('mlpa_allowedpurpose', (
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('mlpa', ['AllowedPurpose'])

        # Adding model 'AllowedTarget'
        db.create_table('mlpa_allowedtarget', (
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('mlpa', ['AllowedTarget'])

        # Adding model 'LopRule'
        db.create_table('mlpa_loprule', (
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('mlpa', ['LopRule'])

        # Adding model 'AllowedUse'
        db.create_table('mlpa_alloweduse', (
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mlpa.AllowedTarget'])),
            ('rule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mlpa.LopRule'], null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lop', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mlpa.Lop'], null=True, blank=True)),
            ('draft', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('purpose', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mlpa.AllowedPurpose'])),
            ('method', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mlpa.AllowedMethod'])),
        ))
        db.send_create_signal('mlpa', ['AllowedUse'])

        # Adding model 'DesignationsPurposes'
        db.create_table('mlpa_designationspurposes', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('designation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpa.MpaDesignation'], unique=True)),
        ))
        db.send_create_signal('mlpa', ['DesignationsPurposes'])

        # Adding M2M table for field purpose on 'DesignationsPurposes'
        db.create_table('mlpa_designationspurposes_purpose', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('designationspurposes', models.ForeignKey(orm['mlpa.designationspurposes'], null=False)),
            ('allowedpurpose', models.ForeignKey(orm['mlpa.allowedpurpose'], null=False))
        ))
        db.create_unique('mlpa_designationspurposes_purpose', ['designationspurposes_id', 'allowedpurpose_id'])

        # Adding model 'GoalCategory'
        db.create_table('mlpa_goalcategory', (
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('mlpa', ['GoalCategory'])

        # Adding model 'GoalObjective'
        db.create_table('mlpa_goalobjective', (
            ('goal_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mlpa.GoalCategory'])),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('mlpa', ['GoalObjective'])

        # Adding model 'MlpaMpa'
        db.create_table('mlpa_mlpampa', (
            ('design_considerations', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group_before_edits', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('dfg_feasability_guidance', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('boundary_description', self.gf('django.db.models.fields.TextField')(default='North Boundary:  [please describe, e.g. "north latitude 36 21.0 to the extent of state waters"]\nWest Boundary:  [please describe, e.g. "the state water boundary"]\nSouth Boundary: [please describe, e.g. "line due west of the northern tip of Sammy\'s Rock: at ~33 21.029"]\nEast Boundary:   [please describe, e.g. "mean high tide line"]', null=True, blank=True)),
            ('geometry_final', self.gf('django.contrib.gis.db.models.fields.PolygonField')(srid=3310, null=True, blank=True)),
            ('sat_explanation', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('is_estuary', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True)),
            ('evolution', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length='255')),
            ('designation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpa.MpaDesignation'], null=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('specific_objective', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.send_create_signal('mlpa', ['MlpaMpa'])

        # Adding M2M table for field allowed_uses on 'MlpaMpa'
        db.create_table('mlpa_mlpampa_allowed_uses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mlpampa', models.ForeignKey(orm['mlpa.mlpampa'], null=False)),
            ('alloweduse', models.ForeignKey(orm['mlpa.alloweduse'], null=False))
        ))
        db.create_unique('mlpa_mlpampa_allowed_uses', ['mlpampa_id', 'alloweduse_id'])

        # Adding M2M table for field sharing_groups on 'MlpaMpa'
        db.create_table('mlpa_mlpampa_sharing_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mlpampa', models.ForeignKey(orm['mlpa.mlpampa'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('mlpa_mlpampa_sharing_groups', ['mlpampa_id', 'group_id'])

        # Adding M2M table for field goal_objectives on 'MlpaMpa'
        db.create_table('mlpa_mlpampa_goal_objectives', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mlpampa', models.ForeignKey(orm['mlpa.mlpampa'], null=False)),
            ('goalobjective', models.ForeignKey(orm['mlpa.goalobjective'], null=False))
        ))
        db.create_unique('mlpa_mlpampa_goal_objectives', ['mlpampa_id', 'goalobjective_id'])

        # Adding model 'MpaLop'
        db.create_table('mlpa_mpalop', (
            ('reason', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('lop', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mlpa.Lop'], null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mpa', self.gf('django.db.models.fields.related.OneToOneField')(related_name='lop_table', unique=True, to=orm['mlpa.MlpaMpa'])),
        ))
        db.send_create_signal('mlpa', ['MpaLop'])

        # Adding model 'LopOverride'
        db.create_table('mlpa_lopoverride', (
            ('lop', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mlpa.Lop'], null=True, blank=True)),
            ('mpa', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mlpa.MlpaMpa'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('mlpa', ['LopOverride'])

        # Adding model 'MpaGeoSort'
        db.create_table('mlpa_mpageosort', (
            ('number', self.gf('django.db.models.fields.FloatField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mpa', self.gf('django.db.models.fields.related.OneToOneField')(related_name='geo_sort', unique=True, to=orm['mlpa.MlpaMpa'])),
        ))
        db.send_create_signal('mlpa', ['MpaGeoSort'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Estuaries'
        db.delete_table('mlpa_estuaries')
        ...
        # Deleting model 'Lop'
        db.delete_table('mlpa_lop')

        # Deleting model 'AllowedMethod'
        db.delete_table('mlpa_allowedmethod')

        # Deleting model 'AllowedPurpose'
        db.delete_table('mlpa_allowedpurpose')

        # Deleting model 'AllowedTarget'
        db.delete_table('mlpa_allowedtarget')

        # Deleting model 'LopRule'
        db.delete_table('mlpa_loprule')

        # Deleting model 'AllowedUse'
        db.delete_table('mlpa_alloweduse')

        # Deleting model 'DesignationsPurposes'
        db.delete_table('mlpa_designationspurposes')

        # Removing M2M table for field purpose on 'DesignationsPurposes'
        db.delete_table('mlpa_designationspurposes_purpose')

        # Deleting model 'GoalCategory'
        db.delete_table('mlpa_goalcategory')

        # Deleting model 'GoalObjective'
        db.delete_table('mlpa_goalobjective')

        # Deleting model 'MlpaMpa'
        db.delete_table('mlpa_mlpampa')

        # Removing M2M table for field allowed_uses on 'MlpaMpa'
        db.delete_table('mlpa_mlpampa_allowed_uses')

        # Removing M2M table for field sharing_groups on 'MlpaMpa'
        db.delete_table('mlpa_mlpampa_sharing_groups')

        # Removing M2M table for field goal_objectives on 'MlpaMpa'
        db.delete_table('mlpa_mlpampa_goal_objectives')

        # Deleting model 'MpaLop'
        db.delete_table('mlpa_mpalop')

        # Deleting model 'LopOverride'
        db.delete_table('mlpa_lopoverride')

        # Deleting model 'MpaGeoSort'
        db.delete_table('mlpa_mpageosort')
