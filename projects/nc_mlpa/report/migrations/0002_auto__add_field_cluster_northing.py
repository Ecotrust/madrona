...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cluster.northing'
        db.add_column('report_cluster', 'northing', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Cluster.northing'
        db.delete_column('report_cluster', 'northing')
