...
def array_habitat_replication(request, array_id, format='html'):
    ...
    return render_to_response(template, {'results': array.clusters_with_habitat.order_by('lop__value', 'bioregion'), 'array': array}, context_instance=RequestContext(request) )
