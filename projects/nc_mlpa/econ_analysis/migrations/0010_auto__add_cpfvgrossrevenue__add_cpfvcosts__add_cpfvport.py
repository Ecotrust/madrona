...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CPFVGrossRevenue'
        db.create_table('econ_analysis_cpfvgrossrevenue', (
            ('gross_revenue', self.gf('django.db.models.fields.FloatField')(default=100)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('port', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['econ_analysis.CPFVPort'])),
        ))
        db.send_create_signal('econ_analysis', ['CPFVGrossRevenue'])

        # Adding model 'CPFVCosts'
        db.create_table('econ_analysis_cpfvcosts', (
        ...
        db.send_create_signal('econ_analysis', ['CPFVCosts'])

        # Adding model 'CPFVPort'
        db.create_table('econ_analysis_cpfvport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')(unique=True)),
        ))
        db.send_create_signal('econ_analysis', ['CPFVPort'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'CPFVGrossRevenue'
        db.delete_table('econ_analysis_cpfvgrossrevenue')

        # Deleting model 'CPFVCosts'
        db.delete_table('econ_analysis_cpfvcosts')

        # Deleting model 'CPFVPort'
        db.delete_table('econ_analysis_cpfvport')
