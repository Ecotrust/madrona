...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'FishingImpactBaselineCost'
        db.delete_table('econ_analysis_fishingimpactbaselinecost')

        # Adding model 'CommercialGrossRevenue'
        db.create_table('econ_analysis_commercialgrossrevenue', (
            ('port', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['econ_analysis.CommercialPort'])),
            ('gross_revenue', self.gf('django.db.models.fields.FloatField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('species', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['econ_analysis.CommercialSpecies'])),
        ))
        db.send_create_signal('econ_analysis', ['CommercialGrossRevenue'])

        # Adding model 'CommercialCosts'
        db.create_table('econ_analysis_commercialcosts', (
            ('percentage_costs', self.gf('django.db.models.fields.FloatField')()),
            ('species', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['econ_analysis.CommercialSpecies'])),
            ('crew', self.gf('django.db.models.fields.FloatField')()),
            ('fuel', self.gf('django.db.models.fields.FloatField')()),
            ('fixed', self.gf('django.db.models.fields.FloatField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('econ_analysis', ['CommercialCosts'])

        # Adding model 'CommercialPort'
        db.create_table('econ_analysis_commercialport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')(unique=True)),
        ))
        db.send_create_signal('econ_analysis', ['CommercialPort'])

        # Adding model 'CommercialSpecies'
        db.create_table('econ_analysis_commercialspecies', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')(unique=True)),
        ))
        db.send_create_signal('econ_analysis', ['CommercialSpecies'])
    
    
    def backwards(self, orm):
        
        # Adding model 'FishingImpactBaselineCost'
        db.create_table('econ_analysis_fishingimpactbaselinecost', (
            ('gross_revenue', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('percentage_costs', self.gf('django.db.models.fields.FloatField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('crew', self.gf('django.db.models.fields.FloatField')()),
            ('fixed', self.gf('django.db.models.fields.FloatField')()),
            ('port', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('econ_analysis', ['FishingImpactBaselineCost'])

        # Deleting model 'CommercialGrossRevenue'
        db.delete_table('econ_analysis_commercialgrossrevenue')

        # Deleting model 'CommercialCosts'
        db.delete_table('econ_analysis_commercialcosts')

        # Deleting model 'CommercialPort'
        db.delete_table('econ_analysis_commercialport')

        # Deleting model 'CommercialSpecies'
        db.delete_table('econ_analysis_commercialspecies')
    ...
    models = {
        ...
        'econ_analysis.commercialcosts': {
            'Meta': {'object_name': 'CommercialCosts'},
            'crew': ('django.db.models.fields.FloatField', [], {}),
            'fixed': ('django.db.models.fields.FloatField', [], {}),
            'fuel': ('django.db.models.fields.FloatField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'percentage_costs': ('django.db.models.fields.FloatField', [], {}),
            'species': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['econ_analysis.CommercialSpecies']"})
        },
        'econ_analysis.commercialgrossrevenue': {
            'Meta': {'object_name': 'CommercialGrossRevenue'},
            'gross_revenue': ('django.db.models.fields.FloatField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'port': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['econ_analysis.CommercialPort']"}),
            'species': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['econ_analysis.CommercialSpecies']"})
        },
        'econ_analysis.commercialport': {
            'Meta': {'object_name': 'CommercialPort'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {'unique': 'True'})
        },
        'econ_analysis.commercialspecies': {
            'Meta': {'object_name': 'CommercialSpecies'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {'unique': 'True'})
        },
