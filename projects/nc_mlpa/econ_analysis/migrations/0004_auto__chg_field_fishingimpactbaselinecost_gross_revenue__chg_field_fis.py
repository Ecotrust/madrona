...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FishingImpactBaselineCost.gross_revenue'
        db.alter_column('econ_analysis_fishingimpactbaselinecost', 'gross_revenue', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'FishingImpactBaselineCost.net_revenue'
        db.alter_column('econ_analysis_fishingimpactbaselinecost', 'net_revenue', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'FishingImpactBaselineCost.gross_revenue'
        db.alter_column('econ_analysis_fishingimpactbaselinecost', 'gross_revenue', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))

        # Changing field 'FishingImpactBaselineCost.net_revenue'
        db.alter_column('econ_analysis_fishingimpactbaselinecost', 'net_revenue', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))
