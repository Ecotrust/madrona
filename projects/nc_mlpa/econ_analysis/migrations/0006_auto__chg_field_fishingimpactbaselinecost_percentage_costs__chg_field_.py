...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FishingImpactBaselineCost.percentage_costs'
        db.alter_column('econ_analysis_fishingimpactbaselinecost', 'percentage_costs', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'FishingImpactBaselineCost.crew'
        db.alter_column('econ_analysis_fishingimpactbaselinecost', 'crew', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'FishingImpactBaselineCost.fuel'
        db.alter_column('econ_analysis_fishingimpactbaselinecost', 'fuel', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'FishingImpactBaselineCost.fixed'
        db.alter_column('econ_analysis_fishingimpactbaselinecost', 'fixed', self.gf('django.db.models.fields.FloatField')())
    
    
    def backwards(self, orm):
        
        # Changing field 'FishingImpactBaselineCost.percentage_costs'
        db.alter_column('econ_analysis_fishingimpactbaselinecost', 'percentage_costs', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'FishingImpactBaselineCost.crew'
        db.alter_column('econ_analysis_fishingimpactbaselinecost', 'crew', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'FishingImpactBaselineCost.fuel'
        db.alter_column('econ_analysis_fishingimpactbaselinecost', 'fuel', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'FishingImpactBaselineCost.fixed'
        db.alter_column('econ_analysis_fishingimpactbaselinecost', 'fixed', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))
    ...
    models = {
        ...
        'econ_analysis.fishingimpactbaselinecost': {
            'Meta': {'object_name': 'FishingImpactBaselineCost'},
            'crew': ('django.db.models.fields.FloatField', [], {}),
            'fixed': ('django.db.models.fields.FloatField', [], {}),
            'fuel': ('django.db.models.fields.FloatField', [], {}),
            'gross_revenue': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'net_revenue': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
