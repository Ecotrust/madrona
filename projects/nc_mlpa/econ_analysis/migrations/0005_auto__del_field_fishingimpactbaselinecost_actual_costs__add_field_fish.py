...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FishingImpactBaselineCost.actual_costs'
        db.delete_column('econ_analysis_fishingimpactbaselinecost', 'actual_costs')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'FishingImpactBaselineCost.actual_costs'
        db.add_column('econ_analysis_fishingimpactbaselinecost', 'actual_costs', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
