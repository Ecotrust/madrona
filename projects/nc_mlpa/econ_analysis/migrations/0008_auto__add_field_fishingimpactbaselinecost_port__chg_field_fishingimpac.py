...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FishingImpactBaselineCost.port'
        db.add_column('econ_analysis_fishingimpactbaselinecost', 'port', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Changing field 'FishingImpactBaselineCost.species'
        db.alter_column('econ_analysis_fishingimpactbaselinecost', 'species', self.gf('django.db.models.fields.TextField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'FishingImpactBaselineCost.port'
        db.delete_column('econ_analysis_fishingimpactbaselinecost', 'port')

        # Changing field 'FishingImpactBaselineCost.species'
        db.alter_column('econ_analysis_fishingimpactbaselinecost', 'species', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'econ_analysis.fishingimpactbaselinecost': {
            ...
            'port': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
