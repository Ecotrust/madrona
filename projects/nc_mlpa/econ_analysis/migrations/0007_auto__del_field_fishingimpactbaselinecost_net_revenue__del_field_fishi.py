...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FishingImpactBaselineCost.net_revenue'
        db.delete_column('econ_analysis_fishingimpactbaselinecost', 'net_revenue')

        # Deleting field 'FishingImpactBaselineCost.total_costs'
        db.delete_column('econ_analysis_fishingimpactbaselinecost', 'total_costs')
    
    
    def backwards(self, orm):
        
        # Adding field 'FishingImpactBaselineCost.net_revenue'
        db.add_column('econ_analysis_fishingimpactbaselinecost', 'net_revenue', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'FishingImpactBaselineCost.total_costs'
        db.add_column('econ_analysis_fishingimpactbaselinecost', 'total_costs', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
