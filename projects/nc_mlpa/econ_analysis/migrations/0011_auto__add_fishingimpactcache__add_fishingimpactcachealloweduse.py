...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FishingImpactCache'
        db.create_table('econ_analysis_fishingimpactcache', (
        ...
        db.send_create_signal('econ_analysis', ['FishingImpactCache'])

        # Adding model 'FishingImpactCacheAllowedUse'
        db.create_table('econ_analysis_fishingimpactcachealloweduse', (
            ('use', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mlpa.AllowedUse'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mpaid', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('econ_analysis', ['FishingImpactCacheAllowedUse'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'FishingImpactCache'
        db.delete_table('econ_analysis_fishingimpactcache')

        # Deleting model 'FishingImpactCacheAllowedUse'
        db.delete_table('econ_analysis_fishingimpactcachealloweduse')
    ...
    models = {
        ...
        'econ_analysis.cpfvcosts': {
            'Meta': {'object_name': 'CPFVCosts'},
            'crew': ('django.db.models.fields.FloatField', [], {'default': '27'}),
            'fixed': ('django.db.models.fields.FloatField', [], {'default': '16.100000000000001'}),
            'fuel': ('django.db.models.fields.FloatField', [], {'default': '8.6999999999999993'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'percentage_costs': ('django.db.models.fields.FloatField', [], {}),
            'port': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['econ_analysis.CPFVPort']"})
        },
        'econ_analysis.cpfvgrossrevenue': {
            'Meta': {'object_name': 'CPFVGrossRevenue'},
            'gross_revenue': ('django.db.models.fields.FloatField', [], {'default': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'port': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['econ_analysis.CPFVPort']"})
        },
        'econ_analysis.cpfvport': {
            'Meta': {'object_name': 'CPFVPort'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {'unique': 'True'})
        },
        ...
        'econ_analysis.fishingimpactcache': {
            'Meta': {'object_name': 'FishingImpactCache'},
        ...
        'econ_analysis.fishingimpactcachealloweduse': {
            'Meta': {'object_name': 'FishingImpactCacheAllowedUse'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mpaid': ('django.db.models.fields.IntegerField', [], {}),
            'use': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mlpa.AllowedUse']"})
        },
