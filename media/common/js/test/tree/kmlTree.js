...
(function(){
    ...
    earthAsyncTest("getState: one element turned off, then back on", function(ge, gex){
        ...
        $(tree).bind('kmlLoaded', function(e, kmlObject){
            ...
            equals(state.children[0].children[0].children[0].children[0].modified.visibility, false);
            // turn back on
            E.find('>span.toggler').click();
            var state = tree.getState();
    ...
    earthAsyncTest("getState: two elements turned off, affecting parents", function(ge, gex){
        ...
        $(tree).bind('kmlLoaded', function(e, kmlObject){
            ...
            equals(state.children[0].children[0].name, 'B');
            equals(state.children[0].children[0].children[0].name, 'D');
            ok(state.children[0].children[0].children[0].modified && state.children[0].children[0].children[0].modified.visibility === false);
            ...
            ok(state.children[0].children[0].children[0].children[0].modified && state.children[0].children[0].children[0].children[0].modified.visibility === false);
            ok(state.children[0].children[0].children[0].children[1].modified && state.children[0].children[0].children[0].children[1].modified.visibility === false);
            A.find('>span.toggler').click();
            var state = tree.getState();
            equals(state.name, 'root');
            equals(state.children.length, 1);
            equals(state.children[0].children[0].name, 'B');
            ok(state.children[0].children[0].modified && state.children[0].children[0].modified.visibility === false);
            ...
            ok(state.children[0].children[0].children[1].children[0].modified && state.children[0].children[0].children[1].children[0].modified.visibility === false);
            ok(state.children[0].children[0].children[1].children[1].modified && state.children[0].children[0].children[1].children[1].modified.visibility === false);
            A.find('>span.toggler').click();
            // turn back on
            C.find('>span.toggler').click();
            var state = tree.getState();
    ...
    earthAsyncTest("getState: parent turned off, affecting children", function(ge, gex){
        ...
        $(tree).bind('kmlLoaded', function(e, kmlObject){
            ...
            ok(state.children[0].children[0].modified && state.children[0].children[0].modified.visibility === false);
            equals(state.children[0].children[0].children[0].name, 'A');
            equals(state.children[0].children[0].children[0].modified.visibility, false);
            equals(state.children[0].children[0].children[1].name, 'D');
            equals(state.children[0].children[0].children[1].modified.visibility, false);
            equals(state.children[0].children[0].children[1].children[0].name, 'C');
            equals(state.children[0].children[0].children[1].children[0].modified.visibility, false);
            equals(state.children[0].children[0].children[1].children[1].name, 'E');
            equals(state.children[0].children[0].children[1].children[1].modified.visibility, false);
            E.find('>span.toggler').click();
            var state = tree.getState();
    ...
    earthAsyncTest("getState: getState tracks open state of Folders and NetworkLinks", function(ge, gex){
        ...
        $(tree).bind('kmlLoaded', function(e, kmlObject){
            ...
            equals(state.children.length, 1);
            equals(state.children[0].children[0].name, 'B');
            ok(state.children[0].children[0].modified && state.children[0].children[0].modified.open === false);
