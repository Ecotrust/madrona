...
$(a)[0])return b;return-1}function o(a,b){j(a,b)===-1&&w.push({node:a,kmlObject:b})}function r(a,b){var d=j(a,b);if(d===-1)throw"removeSelectData error";else w.splice(d,1)}var g={},v=0,l={};g.lookupTable=l;g.kmlObject=null;var k=[];c=jQuery.extend({},e,c);var m=c.gex.pluginInstance,C=false,u={},w=[];parseFloat(m.getPluginVersion())<5.2&&alert("kmltree requires a google earth plugin version >= 5.2");if(!c.url||!c.gex||!c.element||!c.mapElement)throw"kmltree requires options url, gex, mapElement & element";
