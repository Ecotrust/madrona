...
urlpatterns = patterns('lingcod.kmlapp.views',
    ...
    url(r'^public/(?P<session_key>\w+)/public.kmz$', 
        'shared_public', {'kmz': True}, name='kmlapp-publicshared-kmz'),

    url(r'^shared_links/(?P<session_key>\w+)/sharedby-(?P<input_username>\w+).kml$', 
        'create_shared_kml', name='kmlapp-sharedlinks-kml'),
