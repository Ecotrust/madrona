...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('openid', ['Nonce'])

        # Adding model 'Association'
        db.create_table('openid_association', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('openid', ['Association'])

        # Adding model 'UserAssociation'
        db.create_table('openid_userassociation', (
            ('openid_url', self.gf('django.db.models.fields.CharField')(max_length=255, primary_key=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('openid_nonce')

        # Deleting model 'Association'
        db.delete_table('openid_association')
    ...
    models = {
        ...
        'openid.userassociation': {
            'Meta': {'object_name': 'UserAssociation'},
            'openid_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'primary_key': 'True'}),
