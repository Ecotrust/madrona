...
"""   
    ...
    geometry_orig = models.PolygonField(srid=3310,null=True, blank=True, verbose_name="Original MPA boundary")
    geometry_final = models.PolygonField(srid=3310,null=True, blank=True, verbose_name="Final MPA boundary")   
    objects = MpaManager()
