...
class OrganismParametersAdmin(admin.ModelAdmin):
    fields = ('organism','length_units','habitat','habitat_references','range','range_references','biogeography','biogeography_references','pelagic_larval_duration','pelagic_larval_duration_references',
